// This file goes to the "Master" device, or the device that will be reading/displaying
// the temperature.
...
void setup() 
{
  ...
  Wire.begin();     // Start the communication (optional: you may put in a serial number here)
}
...
void loop() 
{
  ...
  {
    buttonVal = Wire.read();    // read the value from the slave device (as a byte)
  }
